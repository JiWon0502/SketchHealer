...
class HParams:
    def __init__(self):
        self.data_location = '/Users/yoonjiwon/Documents/works/SketchHealer/quickdraw_dataset/sketchrnn'#location of  of origin data
        # Load the model on the CPU, even if CUDA is not available
